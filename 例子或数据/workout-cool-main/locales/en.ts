export default {
  ...
  ads: {
    ...
    authority_title: '#1 on Google for "workout"',
    authority_subtitle: "Also ranked #1 on Bing, DuckDuckGo, and Yandex",
    total_visits_label: "Total reach (Feb. 2026)",
    page_views_label: "Page views (Feb. 2026)",
    unique_visitors_label: "Unique visitors (Feb. 2026)",
    device_split_label: "Device split",
    from_last_month: "from last month",
    audience_quality: "Who sees your brand",
    audience_insight: "69.7% male, 18-44 dominant — the exact audience that buys fitness, nutrition, and performance products.",
    top_countries: "Top Countries",
    more_countries: "more",
    similarweb_placeholder: "Traffic share by country — SimilarWeb",
    pricing_starting_at: "Starting at",
    month: "month",
    feature_logo_link: "Your logo & link on every single page",
    ...
    onboarding_success_description:
      "We received your brand details. Your ad will be live within 24 hours. We'll send you a confirmation email.",
    optional: "optional",
  },
} as const;
